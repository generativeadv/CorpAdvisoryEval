    ...
    <div className="max-w-4xl mx-auto p-6 space-y-12">
      ...
      <div className="text-center max-w-2xl mx-auto pt-4">
        ...
        <p className="text-muted-foreground mt-3">
          Every firm is assessed using three interlocking frameworks. Together
          they answer where each firm stands, how they compare, and how
          confident we are in what we know.
        </p>
      </div>
